    ...
    <>
      <View className={"flex-1 relative"}>
        ...
        <SafeAreaView className={"flex flex-1"}>
          ...
          <View
            style={{ height: "7%" }}
            className={"mt-10 mx-4 relative z-50"}
          >
        ...
        {/*  forecast section */}
          ...
          {/*  location */}
            ...
            London,
              <Text className={"text-lg font-semibold text-gray-300"}>United Philippines</Text>
            </Text>
            {/*  weather image */}
          ...
          {/*  degree celsius */}
            <View className={"space-y-2"}>
              <Text className={"text-center font-bold text-white text-6xl ml-5 pt-3"}>
                23&#176;
              </Text>
